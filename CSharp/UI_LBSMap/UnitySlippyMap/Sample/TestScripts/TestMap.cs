...
public class TestMap : MonoBehaviour
{
	...
	private IEnumerator Start()
	{
		...
		// 9 rue Gentil, Lyon
        map.CenterWGS84 = new double[2] { 121.552279, 31.215223 };
        ...
        // GaoDe
        GaoDeTileLayerBehaviour gaodeLayer = map.CreateLayer<GaoDeTileLayerBehaviour>("GaoDe");
        layers.Add(gaodeLayer);
