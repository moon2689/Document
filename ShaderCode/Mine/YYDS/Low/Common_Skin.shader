Shader "TA/Role/Low/Common_Skin"
{
    Properties
    {
        // 纹理------------------------------------------------------------>
		...
		*/
        ...
        _Tattoo2Color ("贴花二颜色", Color) = (1, 1, 1, 1)
		_Tattoo2Zoom("贴花二缩放", float) = 8
        _Tattoo2Rect ("贴花二区域", Vector) = (0.106, 0.545, 0.269, 0.64)
        _Tattoo2PosX ("贴花二位置x", Range(0, 1)) = 0.5
        _Tattoo2PosY ("贴花二位置y", Range(0, 1)) = 0.5
        _Tattoo2Visibility ("贴花二可见性", Range(0, 1)) = 0
        ...
        Pass
        {
            ...
            */
            ...
            half4 Fragment(Varyings input) : SV_Target
            {
                ...
                baseColor *= _SkinColor.rgb; //应用皮肤颜色
                ...
                half tattoo2_u = lerp(_Tattoo2Rect.x, _Tattoo2Rect.x + _Tattoo2Rect.z, _Tattoo2PosX);
                half tattoo2_v = lerp(_Tattoo2Rect.y, _Tattoo2Rect.y + _Tattoo2Rect.w, _Tattoo2PosY);
                ...
                baseColor = lerp(baseColor, tattoo2Col.rgb * _Tattoo2Color.rgb, tattoo2Col.a * _Tattoo2Visibility);
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Fragment(Varyings input) : SV_Target
            {
                ...
                half3 diffL = -GetViewForwardDir(); // 取摄像机前方方向作为光源方向
                half NoL = dot(N, diffL);
				//finalColor += baseColor * (NoL * 0.5 + 0.5);
