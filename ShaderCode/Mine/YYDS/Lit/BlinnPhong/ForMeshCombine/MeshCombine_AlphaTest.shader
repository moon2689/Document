Shader "TA/Lit/BlinnPhong/ForMeshCombine/Alpha Test"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
            ...
            #include "../../../Optimize/Library/CommonLighting.hlsl"
            //#include "../../../Library/PBRLighting_Standard.hlsl"
            ...
            half4 Fragment(Varyings input) : SV_Target
			{
                ...
                half4 color = Lighting_HalfBlinnPhong(diffCol, specCol, alpha, smoothness, N, V);
                ...
                */
				...
				half alphaRef = SAMPLE_TEXTURE3D(_DitherMaskLOD, sampler_DitherMaskLOD, float3(vpos.xy * 0.3, baseMap.a * 0.9375)).a;
				clip( alphaRef - 0.01 );
