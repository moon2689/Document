Shader "TA/Lit/PBR/Common_Skin_FaceDress"
{
    Properties
    {
        // 眼球------------------------------------------------------------>
        ...
        [Tex] [NoScaleOffset] _EyeshadowNormalMap ("眼影法线贴图", 2D) = "black" { }
        ...
        _EyelinerColor ("眼线颜色", Color) = (0, 0, 0, 1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            TEXTURE2D(_EyeshadowNormalMap); SAMPLER(sampler_EyeshadowNormalMap);
            ...
            half4 Fragment(Varyings input) : SV_Target
            {
                ...
                half3 baseColorEyeshadow = lerp(eyeshadowMap.rgb, _EyelinerColor.rgb, eyelinerMap.a);
