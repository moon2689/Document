...
half3 LightingPhysicallyBased_MainLit(half3 diffCol, half3 specCol, Light light, half3 N, half3 V, half roughnessPow2, half roughnessPow4)
{
    ...
    half3 radiance = light.color * diffuseShadow * NdotL;
...
half3 LightingPhysicallyBased_AddLit(half3 diffCol, half3 specCol, Light light, half3 N, half3 V, half roughnessPow2, half roughnessPow4)
{
    half3 L = light.direction;
    half NdotL = saturate(dot(N, L));
    half3 radiance = light.color * (light.distanceAttenuation * light.shadowAttenuation * NdotL);
...
//#endif
    ...
    half3 mainLightColor = LightingPhysicallyBased_MainLit(brdfDiffuse, brdfSpecular, mainLight, N, V, roughnessPow2, roughnessPow4);
    ...
    half3 addLightColor = half3(0, 0, 0);
        ...
        for(uint lightIndex = 0; lightIndex < pixelLightCount; ++lightIndex)
        {
            ...
            addLightColor += LightingPhysicallyBased_AddLit(brdfDiffuse, brdfSpecular, addLight, N, V, roughnessPow2, roughnessPow4);
        }
    #endif
...
half4 UniversalFragmentPBR_Skin(InputData inputData, SurfaceData surfaceData)
{
