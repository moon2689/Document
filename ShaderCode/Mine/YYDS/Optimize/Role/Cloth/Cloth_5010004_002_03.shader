Shader "TA/Optimize/Role/Cloth/5010004_002_03"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN , FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float fresnelNode46 = ( _FresnelBiss + _FresnelScale * pow( 1.0 - fresnelNdotV46, _FresnelPower ) );
				float4 switchResult119 = (((ase_vface>0)?(( fresnelNode46 * _FresnelColor )):(float4( 0,0,0,0 ))));
				...
				float4 temp_output_53_0 = ( ( cloth_D103 * ( _MetallicReflection * _MetallicReflectionColor * Metallic93 * texCUBENode78 ) ) + ( ( Metallic93 * texCUBENode78 * _ReflectionColor ) * ( 1.0 - Smoothness92 ) * _Reflection ) );
				...
				float DiffuseMultiple130 = _DiffuseMultiple;
				
				float cloth_A105 = tex2DNode6.a;
				
				float3 Albedo = ( ( switchResult119 + temp_output_53_0 + ( _Brightness * ( saturate( lerpBlendMode114 )) ) ) * DiffuseMultiple130 ).rgb;
