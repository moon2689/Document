Shader "America/Character/Tattoo/NewEffect/FlowHighLight/FlowHighLight Toony-Lighted-Cutoff"
{
	Properties
	{
	...
	SubShader 
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f i) : SV_TARGET
			{
				...
				fixed4 col = fixed4(diffuse * _DiffuseRate + specular * _SpecularRate + flowCol, a.r);
