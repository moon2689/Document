Shader "America/Character/Tattoo/NewEffect/FlowHighLight/FlowHighLight Toony-Lighted-ColorMask-Skin"
{
	Properties
	{
	...
	SubShader 
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f i) : SV_TARGET
			{
				...
				fixed ca = tex2D(_MainTexMask, i.uv).rgb;
				
				//fixed3 emission = ((1 - ca) * ct.rgb ) * _Color;
				...
				fixed4 col = fixed4(diffuse * _DiffuseRate + specular * _SpecularRate + flowCol, ct.a);
