Shader "America/Character/Tattoo/NewEffect/FlowHighLight/FlowHighLight Toony-Lighted-ColorMask"
{
	Properties
	{
	...
	SubShader 
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f i) : SV_TARGET
			{
				...
				fixed4 col = fixed4(emission + ambient + diffuse * _DiffuseRate + specular * _SpecularRate + flowCol, ct.a);
