Shader "America/Character/Tattoo/NewEffect/Highlight/Highlight Lighted (Alpha Blend)(Two Sides)Lv2"
{
	Properties
	{
	...
	SubShader 
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f i) : SV_TARGET
			{
				...
				// 纹身
				col = ApplyTattoo(i.uv, _TattooTex1, _TattooPos1, col);
				col = ApplyTattoo(i.uv, _TattooTex2, _TattooPos2, col);
				col = ApplyTattoo(i.uv, _TattooTex3, _TattooPos3, col);
				col = ApplyTattoo(i.uv, _TattooTex4, _TattooPos4, col);
