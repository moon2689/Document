Shader "America/Character/Tattoo/NewEffect/Highlight/Highlight Lighted (Alpha Blend)"
{
	Properties
	{
	...
	SubShader 
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f i) : SV_TARGET
			{
				...
				// spec
				fixed3 specular = CalcSpecular(worldView, worldLight, worldNormal, _SpecularGloss, _SpecularMask, i.uv);
