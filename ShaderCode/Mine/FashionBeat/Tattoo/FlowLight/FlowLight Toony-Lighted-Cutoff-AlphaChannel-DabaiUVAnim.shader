Shader "America/Character/Tattoo/NewEffect/FlowLight/FlowLight Toony-Lighted-Cutoff-AlphaChannel-DabaiUVAnim"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag(v2f i) : SV_TARGET
			{
				...
				fixed4 albedo = tex2D(_MainTex, i.uv + float2(0.25 * _CellX, -0.25 * _CellY));
				...
				fixed4 col = fixed4(diffuse * _DiffuseRate + flowCol, albedo.a);
