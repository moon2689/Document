Shader "MyURP/Kerry/IBL/URPIBLProbe"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag (v2f i) : SV_Target
			{
				...
				half4 color_cubemap = SAMPLE_TEXTURECUBE_LOD(unity_SpecCube0, samplerunity_SpecCube0, reflect_dir, mip_level);
				half3 env_color = DecodeHDREnvironment(color_cubemap, unity_SpecCube0_HDR);//确保在移动端能拿到HDR信息
