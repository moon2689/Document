...
Shader "Kerry/URP/PBR/ASE_Standard"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float localDirectLighting1_g1 = ( 0.0 );
				float2 uv_BaseMap = IN.ase_texcoord8.xy * _BaseMap_ST.xy + _BaseMap_ST.zw;
				float3 temp_output_6_0_g1 = SAMPLE_TEXTURE2D( _BaseMap, sampler_BaseMap, uv_BaseMap ).rgb;
				float2 uv_MRA = IN.ase_texcoord8.xy * _MRA_ST.xy + _MRA_ST.zw;
				float4 tex2DNode17 = SAMPLE_TEXTURE2D( _MRA, sampler_MRA, uv_MRA );
				float temp_output_8_0_g1 = tex2DNode17.r;
				float3 lerpResult11_g1 = lerp( temp_output_6_0_g1 , float3( 0,0,0 ) , temp_output_8_0_g1);
				float3 DiffuseColor1_g1 = lerpResult11_g1;
				float3 temp_cast_2 = (( 0.5 * 0.08 )).xxx;
				float3 lerpResult12_g1 = lerp( temp_cast_2 , temp_output_6_0_g1 , temp_output_8_0_g1);
				float3 SpecularColor1_g1 = lerpResult12_g1;
				float temp_output_10_0_g1 = tex2DNode17.g;
				float Roughness1_g1 = temp_output_10_0_g1;
				float3 WorldPos1_g1 = WorldPosition;
				...
				float3 tangentToWorldDir16_g1 = normalize( mul( ase_tangentToWorldFast, UnpackNormalScale( SAMPLE_TEXTURE2D( _NormalMap, sampler_NormalMap, uv_NormalMap ), 1.0f ) ) );
				float3 N1_g1 = tangentToWorldDir16_g1;
				float3 V1_g1 = WorldViewDirection;
				float3 DirectLighting1_g1 = float3( 0,0,0 );
				DirectLighting_float( DiffuseColor1_g1 , SpecularColor1_g1 , Roughness1_g1 , WorldPos1_g1 , N1_g1 , V1_g1 , DirectLighting1_g1 );
				float localIndirectLighting2_g1 = ( 0.0 );
				float3 DiffuseColor2_g1 = lerpResult11_g1;
				float3 SpecularColor2_g1 = lerpResult12_g1;
				float Roughness2_g1 = temp_output_10_0_g1;
				float3 WorldPos2_g1 = WorldPosition;
				float3 N2_g1 = tangentToWorldDir16_g1;
				float3 V2_g1 = WorldViewDirection;
				float Occlusion2_g1 = tex2DNode17.b;
				float EnvRotation2_g1 = _EnvRotation;
				float3 IndirectLighting2_g1 = float3( 0,0,0 );
				IndirectLighting_float( DiffuseColor2_g1 , SpecularColor2_g1 , Roughness2_g1 , WorldPos2_g1 , N2_g1 , V2_g1 , Occlusion2_g1 , EnvRotation2_g1 , IndirectLighting2_g1 );
				
				float3 temp_cast_3 = (0.0).xxx;
				
				float3 Albedo = temp_cast_0;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( DirectLighting1_g1 + IndirectLighting2_g1 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 temp_output_6_0_g1 = SAMPLE_TEXTURE2D( _BaseMap, sampler_BaseMap, uv_BaseMap ).rgb;
				float2 uv_MRA = IN.ase_texcoord4.xy * _MRA_ST.xy + _MRA_ST.zw;
				float4 tex2DNode17 = SAMPLE_TEXTURE2D( _MRA, sampler_MRA, uv_MRA );
				float temp_output_8_0_g1 = tex2DNode17.r;
				float3 lerpResult11_g1 = lerp( temp_output_6_0_g1 , float3( 0,0,0 ) , temp_output_8_0_g1);
				float3 DiffuseColor1_g1 = lerpResult11_g1;
...
/*ASEBEGIN
Version=18935
7;13;1906;1039;2710.079;1000.572;2.009707;True;False
Node;AmplifyShaderEditor.SamplerNode;16;-1308.752,-95.78827;Inherit;True;Property;_BaseMap;BaseMap;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;17;-1261.627,131.581;Inherit;True;Property;_MRA;MRA;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;18;-1283.627,340.581;Inherit;True;Property;_NormalMap;NormalMap;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;19;-956.6274,447.581;Inherit;False;Property;_EnvRotation;EnvRotation;3;0;Create;True;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;15;-647,49.5;Inherit;False;ASE_StandardMaster;-1;;1;9e0588c63a0a80e48b813b48f82617eb;0;7;6;FLOAT3;0,0,0;False;14;FLOAT;0.5;False;8;FLOAT;0;False;10;FLOAT;0;False;9;FLOAT3;0,0,0;False;19;FLOAT;0;False;20;FLOAT;0;False;1;FLOAT3;0
...
WireConnection;15;6;16;0
WireConnection;15;8;17;1
WireConnection;15;10;17;2
WireConnection;15;9;18;0
WireConnection;15;19;17;3
WireConnection;15;20;19;0
...
ASEEND*/
//CHKSM=EEA5BC901BD5B89ABAA779863D4E369F15AC41AC