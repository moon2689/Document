Shader "RuoXi/URP/Lit/PBR/PBRRuoXiHairCap"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                float3 diffuseCol = baseMap.rgb * _Color;
                float3 specCol = 0.04.xxx;

                float3 pbrLighing= PBRLighting_Standard(diffuseCol, specCol, worldNormal, worldPos, 1, 1);
