Shader "Kerry/Lethe/Char_Standard"
{
	Properties
	{
		[Header(BaseInfo)]
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag (v2f i) : SV_Target
			{
				...
				#ifdef _SPECCHECK_ON
				half3 direct_specular = spec_term * spec_color
				 * _LightColor0.xyz * atten;
				#else
				...
				float3 final_color = direct_diffuse + direct_specular 
					+ env_diffuse + env_specular;
