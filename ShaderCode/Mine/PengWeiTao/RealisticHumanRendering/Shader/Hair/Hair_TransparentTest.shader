Shader "RealHuman/Hair_TransparentTest"
{
    Properties
    {
        ...
        [Space(20)]
        _AlphaOp("Alpha OP",Vector) = (0,1,0,0)
        [Space(20)]
        _ShadowIntensity("Shadow Intensity",Range(0,1)) =0.2
         
        [Space(20)]
        [Toggle(ENABLE_SH_ON)] _EnableSH("Enable SH Lighting",Float) = 1
    }
    SubShader
    {
        //URP中默认的渲染顺序关键字
        //先判断 队列在判断Queue "LightMode"
        //1.SRPDefaultUnlit
        //2.UniversalForward
...
//            Tags {"LightMode" = "UniverseForward" }
