...
public class ViewAndProjectionMatrix
{
    public Matrix4x4 View;
    public Matrix4x4 Projection;
}

public class CharacterShadowUtility
{
    ...
    private float shadowClipDistance = 10;
    ...
    public void Init(Transform shadowCaster,Light mainLight,float shadowClipDistance=10)
    {
        this.shadowCaster = shadowCaster;
        this.mainLight = mainLight;
        this.shadowClipDistance = shadowClipDistance;
    ...
    public ViewAndProjectionMatrix GetViewAndProjectionMatrix()
    {
        UpdateAABB();
        fitToScene();
        ViewAndProjectionMatrix vap = new ViewAndProjectionMatrix();
        vap.View = viewMatrix;
        vap.Projection = projMatrix;
        return vap;
    }
